...
For this test, I kept the generation setup simple. I used a 3:5 aspect ratio, set the Resolution to XL, and selected Batch (x4) to generate four images from the same prompt. This gave me several results to compare while keeping the character description and generation settings consistent.
